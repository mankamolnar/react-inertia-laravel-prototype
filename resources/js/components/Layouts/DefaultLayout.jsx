...
const DefaultLayout = ({ children }) => {
    ...
    useEffect(() => {
        ...
        return () => { window.removeEventListener("onscroll", onScrollHandler); }
    }, []);
    ...
    return (
        <App>
            ...
            <div className="relative">
                ...
                {/* screen loader */}
                {showLoader && (<div className="screen_loader fixed inset-0 bg-[#fafafa] dark:bg-[#060818] z-[60] grid place-content-center animate__animated">
